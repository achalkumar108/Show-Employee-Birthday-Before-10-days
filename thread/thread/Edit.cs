...
namespace MyProgram
{
    public partial class program1
    {
        ...
        //static void LoginAgainThread()
        //{
        //    Thread.Sleep(2000);
        //    Console.WriteLine($"Logging in again with '{username}'...");
        //    isLoggedIn = true;
        //    Console.WriteLine($"User '{username}' logged in again with last created username.");
        //}
    }
    class Program
    {
